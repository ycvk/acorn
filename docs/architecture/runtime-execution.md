...
- Tool progress never enters model context directly. The model sees the final tool message; progress remains persisted diagnostic trace rather than default mobile live UI.
