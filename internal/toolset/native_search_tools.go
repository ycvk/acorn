...
func buildSearchTextTool(ws WorkspaceView) (einotool.BaseTool, error) {
	tool, err := inferProgressTool("search_text", "Search workspace text files without dropping to raw command execution.", func(ctx context.Context, input SearchTextInput, emit tools.ToolProgressEmitter) (SearchTextOutput, error) {
...
func runSearchText(ctx context.Context, ws WorkspaceView, input SearchTextInput, emit tools.ToolProgressEmitter) (SearchTextOutput, error) {
...
func searchWorkspaceFiles(ctx context.Context, ws WorkspaceView, basePath, baseRel, query string, input SearchTextInput, matcher func(string) (int, bool), limit int, emit tools.ToolProgressEmitter) (SearchTextOutput, error) {
...
func scanSearchFile(ctx context.Context, ws WorkspaceView, current string, matcher func(string) (int, bool), state *searchState, limit int, emit tools.ToolProgressEmitter) error {
...
func collectSearchMatches(ctx context.Context, rel string, body []byte, matcher func(string) (int, bool), state *searchState, limit int, emit tools.ToolProgressEmitter) error {
	lineNo := 1
