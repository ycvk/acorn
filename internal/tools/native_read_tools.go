...
func runReadFile(ctx context.Context, ws WorkspaceView, input ReadFileInput, emit tooling.ToolProgressEmitter) (ReadFileOutput, error) {
...
func readResolvedFile(ctx context.Context, resolved string, body []byte, input ReadFileInput, emit tooling.ToolProgressEmitter) (ReadFileOutput, error) {
...
func runListFiles(ctx context.Context, ws WorkspaceView, input ListFilesInput, emit tooling.ToolProgressEmitter) (ListFilesOutput, error) {
...
func visitListFile(ctx context.Context, ws WorkspaceView, basePath, current string, entry fs.DirEntry, pattern string, state *listFilesState, limit int, emit tooling.ToolProgressEmitter) error {
	if current == basePath {
		return nil
	}
...
func appendListEntry(ctx context.Context, state *listFilesState, rel string, entry fs.DirEntry, info fs.FileInfo, emit tooling.ToolProgressEmitter) error {
