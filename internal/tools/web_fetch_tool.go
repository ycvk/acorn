...
func buildWebFetchTool(fetcher WebFetchService, artifactService ArtifactService, bridge ArtifactContext) (einotool.BaseTool, error) {
	...
	tool, err := inferProgressTool("web_fetch", "Fetch a public HTTP(S) URL, extract Markdown, and persist raw/Markdown artifacts.", func(ctx context.Context, input WebFetchInput, emit tooling.ToolProgressEmitter) (WebFetchOutput, error) {
