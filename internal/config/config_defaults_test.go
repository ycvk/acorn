...
func TestDefaultConfigValues(t *testing.T) {
	...
	tests := []struct {
		...
		{"memory.semantic.bleve.index_name", cfg.Memory.Semantic.Bleve.IndexName, "memory_records"},
		{"memory.semantic.embedding.provider", cfg.Memory.Semantic.Embedding.Provider, "openai_compatible"},
		{"memory.semantic.embedding.model", cfg.Memory.Semantic.Embedding.Model, "text-embedding-3-small"},
		{"memory.semantic.embedding.base_url", cfg.Memory.Semantic.Embedding.BaseURL, "https://api.openai.com/v1"},
