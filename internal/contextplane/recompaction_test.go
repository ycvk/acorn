...
func TestBuildSummarizerInputUsesPreviousSummary(t *testing.T) {
	...
	input1, err := buildSummarizerInput("", messages, PreservePolicy{RecentTurns: 1, PreserveToolPairs: true})
	if err != nil {
	...
	input2, err := buildSummarizerInput(previousSummary, messages, PreservePolicy{RecentTurns: 1, PreserveToolPairs: true})
	if err != nil {
