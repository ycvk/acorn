...
func (h chatTestExecutorHandle) Run(ctx context.Context, input, skillID string, sink runtime.StreamSink) (*runtime.Result, error) {
	panic("unexpected Run call")
}

func (h chatTestExecutorHandle) ExecuteMessages(ctx context.Context, req runtime.ExecuteRequest, sink runtime.StreamSink) (*runtime.Result, error) {
...
func (h chatTestExecutorHandle) ResumeWithTargets(ctx context.Context, runID string, targets map[string]any, sink runtime.StreamSink) (*runtime.Result, error) {
