...
func TestAuditedToolRecordsSucceededEvent(t *testing.T) {
	...
	runCtx := withRunID(context.Background(), "run_success")
...
func TestAuditedToolRecordsProgressEvent(t *testing.T) {
	...
	invokable := wrapped.(einotool.InvokableTool)
	runCtx := withToolAuditCallID(withRunID(context.Background(), "run_progress"), "call_progress")
...
func TestAuditedToolRecordsInterruptedEvent(t *testing.T) {
	...
	invokable := wrapped.(einotool.InvokableTool)
	runCtx := withRunID(context.Background(), "run_interrupt")
...
func TestValidationBlocksInvalidArguments(t *testing.T) {
	...
	runCtx := withRunID(context.Background(), "run_validation_block")
...
func TestValidationAllowsValidArguments(t *testing.T) {
	...
	runCtx := withRunID(context.Background(), "run_validation_allow")
...
func TestValidationFailuresDoNotCreateRepairState(t *testing.T) {
	...
	runCtx := withRunID(context.Background(), "run_validation_no_repair_state")
