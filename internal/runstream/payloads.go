...
func ElicitationPayloadWithStreamKind(payload ElicitationPayload, kind StreamItemKind) ElicitationPayload {
	payload.streamKind = kind
	return payload
}
...
func SamplingPayloadWithStreamKind(payload SamplingPayload, kind StreamItemKind) SamplingPayload {
	payload.streamKind = kind
	return payload
}
