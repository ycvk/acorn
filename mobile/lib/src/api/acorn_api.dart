...
class AcornApiClient {
  ...
  Future<DevicePushToken> registerDevicePushToken(
    String deviceId,
    RegisterDevicePushTokenRequest request,
  ) async {
    final json = await _putJson(
      '/v1/devices/${Uri.encodeComponent(deviceId)}/push-token',
      request.toJson(),
    );
  ...
  Future<void> revokeDevicePushToken(String deviceId, String provider) async {
    final response = await _http.delete(
      _uri(
        '/v1/devices/${Uri.encodeComponent(deviceId)}/push-token/${Uri.encodeComponent(provider)}',
        null,
      ),
  ...
  Future<PendingActionDetail> getPendingAction(String actionId) async {
    final json = await _getJson(
      '/v1/pending-actions/${Uri.encodeComponent(actionId)}',
    );
  ...
  Future<InterruptRunResponse> interruptRun(String runId) async {
    final json = await _postJson(
      '/v1/runs/${Uri.encodeComponent(runId)}:interrupt',
      <String, dynamic>{},
    );
  ...
  Future<RunResult> resumeRun(String runId) async {
    final json = await _postJson(
      '/v1/runs/${Uri.encodeComponent(runId)}:resume',
      <String, dynamic>{},
    );
  ...
  Future<RunDetail> getRunDetail(String runId) async {
    final json = await _getJson(
      '/v1/runs/${Uri.encodeComponent(runId)}/detail',
    );
  ...
  factory InboxResponse.fromJson(Map<String, dynamic> json) {
    return InboxResponse(
      pendingActions: _list(
        ...
        PendingActionSummary.fromJson,
      ),
      activeRuns: _list(json['active_runs'], RunSummary.fromJson),
      recentTerminalRuns: _list(
        json['recent_terminal_runs'],
        RunSummary.fromJson,
      ),
...
class PendingActionListResponse {
  ...
  factory PendingActionListResponse.fromJson(Map<String, dynamic> json) {
    return PendingActionListResponse(
      items: _list(json['items'], PendingActionSummary.fromJson),
    );
  }
}
...
class InterruptRunResponse {
  const InterruptRunResponse({required this.runId, required this.status});
...
class MemoryRecordListResponse {
  ...
  factory MemoryRecordListResponse.fromJson(Map<String, dynamic> json) {
    return MemoryRecordListResponse(
      items: _list(json['items'], MemoryRecord.fromJson),
    );
  }
}
...
class MemorySearchResponse {
  ...
  factory MemorySearchResponse.fromJson(Map<String, dynamic> json) {
    return MemorySearchResponse(
      items: _list(json['items'], MemorySearchItem.fromJson),
    );
  }
}
...
class SystemStatus {
  ...
  factory SystemStatus.fromJson(Map<String, dynamic> json) {
    return SystemStatus(
      runtimeReadiness: RuntimeReadiness.fromJson(
        _map(json['runtime_readiness']),
      ),
      providerReadiness: _list(
        json['provider_readiness'],
        ProviderReadiness.fromJson,
      ),
